...
function TermsEnglish(): React.ReactElement {
  return (
    <div className="mx-auto my-16 max-w-2xl text-wrap">
      ...
      <div className="mt-2 font-semibold">Effective Date: January 15, 2024</div>
      <p className="mt-4">
        Welcome to Horizon! These Terms of Service ("Terms") govern your use of
        the Horizon application and its related services (the "Service"). By
        using the Service, you agree to comply with and be bound by these Terms.
      ...
      <ol className="mt-8 space-y-4">
        <li>
          ...
          understood, and agree to be bound by these Terms. Horizon reserves the
          right to update, change, or modify these Terms at any time without
        ...
        <li>
          ...
          <ol className="ml-4">
            <li>
              ...
              right to remove any content that violates these Terms or is deemed
              inappropriate.
            </li>
            <li>
        ...
        <li>
          ...
          <ol className="ml-4">
            <li>
              ...
              may enlist for services listed on Horizon. The transaction terms,
              including payment and service details, are to be agreed upon
              between the service provider and the user. Horizon is not
        ...
        <li>
          <span className="font-bold">7. Disclaimers</span>: Horizon is provided
          "as is" and without any warranty or condition, express, implied, or
          statutory. We do not guarantee the availability, accuracy,
      ...
      <p className="mt-8">
        By using the Horizon app, you agree to these Terms of Service. Thank you
...
function TermsTurkish(): React.ReactElement {
  return (
    <div className="mx-auto my-16 max-w-2xl text-wrap">
      ...
      <div className="mt-2 font-semibold">Geçerlilik Tarihi: Ocak 15, 2024</div>
      <p className="mt-4">
        Horizon'a hoş geldiniz! Bu Hizmet Şartları ("Şartlar"), Horizon
        uygulaması ve ilgili hizmetlerinizi ("Hizmet") kullanımınızı
        düzenlemektedir. Hizmeti kullanarak, bu şartlara uymayı ve bağlı kalmayı
        kabul etmiş olursunuz. Bu şartları kabul etmiyorsanız, lütfen hizmeti
        kullanmayın.
      </p>
      <ol className="mt-8 space-y-4">
        <li>
          ...
          edersiniz. Horizon, bu şartları önceden bildirim yapmaksızın herhangi
          bir zamanda güncelleme, değiştirme veya değiştirme hakkını saklı
          tutar. Bu şartları periyodik olarak gözden geçirmek sizin
          sorumluluğunuzdadır.
        </li>
        <li>
        ...
        <li>
          ...
          <ol className="ml-4">
            ...
            <li>
              ...
              kullanmalıdır. Taciz edici, saldırgan veya diğerlerinin haklarını
              ihlal eden herhangi bir iletişim kesinlikle yasaktır.
            </li>
          </ol>
        </li>
        <li>
          ...
          <ol className="ml-4">
            ...
            <li>
              <span className="font-bold">b. Hizmet Sağlayıcılar</span>: Hizmet
              sağlayıcıları, belirtildiği gibi hizmetleri teslim etmekten
              sorumludur. Bu yapılmadığında hesap askıya alınabilir veya
              sonlandırılabilir.
            </li>
          </ol>
        </li>
        <li>
          <span className="font-bold">5. Gizlilik Politikası</span>: Hizmetinizi
          kullanmanız aynı zamanda gizlilik politikamız tarafından da
          düzenlenir,{' '}
          <Link
            to="/privacy"
            className="ml-1 text-sky-600"
        ...
        <li>
          ...
          inandığımız veya hizmetin diğer kullanıcılarına, Horizon'a veya üçüncü
          taraflara zarar veren bir davranış nedeniyle hesabınızı askıya
        ...
        <li>
          <span className="font-bold">8. Sorumluluk Sınırlaması</span>: Horizon,
          doğrudan veya dolaylı olarak ortaya çıkan herhangi bir dolaylı,
          tesadüfi, özel, dolaylı veya cezai zarardan veya kar veya gelir
          kaybından sorumlu değildir.
        </li>
        <li>
          <span className="font-bold">9. Hüküm ve Koşulların Yönetimi</span>: Bu
          Şartlar Türkiye yasalarına tabi olacak şekilde düzenlenir ve
          yorumlanır.
        </li>
        <li>
          <span className="font-bold">10. İletişim Bilgileri</span>: Bu Şartlar
          veya Hizmetle ilgili sorularınız için lütfen bize
